namespace Wordle.Engine
{
    public class InMemoryWordsDictionaryService : IWordsDictionaryService
    {
        ...
        {
            return Task.FromResult(validWords.Contains(word.ToLowerInvariant()));
        }

        public Task<string> PickWordToGuess()
        {
            var randomIndex = random.Next(0, wordsToGuess.Length);
            return Task.FromResult(wordsToGuess[randomIndex]);
        }
